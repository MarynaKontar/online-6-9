...
//    Intrinsic lock are acquired on a per-thread basis rather than per-method call basis. Once a thread has acquired
//    the lock it can internally call other methods without reacquiring the lock. The Lock will only be release when
